...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.holidayStyle = const TextStyle(color: const Color(0xFFA0BEDC)), // Material red[500]
    this.selectedStyle = const TextStyle(color: const Color(0xFFA0BEDC), fontSize: 16.0), // Material grey[50]
    this.todayStyle = const TextStyle(color: const Color(0xFFA0BEDC), fontSize: 16.0), // Material grey[50]
    this.outsideStyle = const TextStyle(color: const Color(0xFFA0BEDC)), // Material grey[500]
    this.outsideWeekendStyle = const TextStyle(color: const Color(0xFFA0BEDC)), // Material red[200]
    this.outsideHolidayStyle = const TextStyle(color: const Color(0xFFA0BEDC)), // Material red[200]
